...
// import { FileText, Users, Network, Zap, TrendingUp, BookOpen, Video, Users2, Headphones } from "lucide-react"

// export default function ForDSAsPage() {
//   return (
//     <div className="min-h-screen bg-white">
//       <Header />

//       {/* Hero Section */}
//       <section id="for-dsas" className="relative bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 py-16 overflow-hidden">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
//           <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">You run your business.</h1>
//           <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
//             We empower you with digital tools and banking integrations, with 100% data security.
//           </h2>
//           <p className="text-xl text-white mb-8">
//             Mitram360 is empowering all major banks/NBFCs with digitisation since 2009.
//           </p>
...
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-3">Paperless To Approval</h3>
//                 <p className="text-gray-600 leading-relaxed">
//                   Mitram360 offers complete seamless digital journey from first time file login to loan sanction
//                 </p>
//               </div>
//             </div>
...
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-3">No Customer Goes Without</h3>
//                 <p className="text-gray-600 leading-relaxed">
...
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-3">Strong Lender Portfolio</h3>
//                 <p className="text-gray-600 leading-relaxed">
//                   A strong lender portfolio gives flexibility to login single loan file to multiple lenders
//                 </p>
//               </div>
//             </div>
...
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-3">Fastest, Auditable Payouts</h3>
//                 <p className="text-gray-600 leading-relaxed">
...
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-3">Build Network, Business</h3>
//                 <p className="text-gray-600 leading-relaxed">
//                   Performance management allows to add team members and track their performance
//                 </p>
//               </div>
//             </div>
//           </div>
...
//                 <h3 className="text-2xl font-bold text-white">Home Loan</h3>
//               </div>
//             </Card>

//             <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 border-0 shadow-lg">
//               <div className="h-48 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center">
//                 <h3 className="text-2xl font-bold text-white">Loan Against Property</h3>
//               </div>
//             </Card>

//             <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 border-0 shadow-lg">
//               <div className="h-48 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center">
//                 <h3 className="text-2xl font-bold text-white">Business Loan</h3>
//               </div>
//             </Card>

//             <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 border-0 shadow-lg">
//               <div className="h-48 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center">
//                 <h3 className="text-2xl font-bold text-white">Personal Loan</h3>
//               </div>
//             </Card>

//             <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 border-0 shadow-lg">
//               <div className="h-48 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center">
//                 <h3 className="text-2xl font-bold text-white">Working Capital</h3>
//               </div>
//             </Card>

//             <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 border-0 shadow-lg">
//               <div className="h-48 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center">
//                 <h3 className="text-2xl font-bold text-white">Loan Against Securities</h3>
//               </div>
//             </Card>
//           </div>
//         </div>
...
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <h2 className="text-4xl font-bold text-orange-500 text-center mb-16">How it works?</h2>
...
//                 Now you are ready to send your lead in just a single click.
//               </p>
//               <p className="text-xl text-gray-700 leading-relaxed">Rest we take care of</p>
//             </div>
//           </div>
...
export default function ForDSAsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="for-dsas"
        className="relative bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 py-16 overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">You run your business.</h1>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
