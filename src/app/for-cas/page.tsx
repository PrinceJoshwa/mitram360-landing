...
//       {/* Hero Section */}
//       <section id="for-cas" className="relative bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 py-20 overflow-hidden">
...
export default function ForCAsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="for-cas"
        className="relative bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 py-20 overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8">
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        checked={formData.partnerType === "Chartered Accountant (CA)"}
                        onChange={handleInputChange}
                    ...
                    <label className="flex items-center space-x-3">
                      <input
                        type="radio"
                        name="partnerType"
                        value="Lending Partner (Banks & NBFCs)"
                        checked={formData.partnerType === "Lending Partner (Banks & NBFCs)"}
                        onChange={handleInputChange}
                        className="w-4 h-4 text-orange-500"
                      />
                      <span className="text-sm font-medium">Lending Partner (Banks & NBFCs)</span>
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      type="radio"
                      name="partnerType"
                      value="Direct Selling Agent (DSA)"
                      checked={formData.partnerType === "Direct Selling Agent (DSA)"}
                      onChange={handleInputChange}
                      className="w-4 h-4 text-orange-500"
                    />
                    <span className="text-sm font-medium">Direct Selling Agent (DSA)</span>
